<template>
  <SingleTableView :singleTable="singleTable" :modalComponent="modalComponent" modalTitle="模板"
                   :class="useModernListSkin ? 'modern-list-page cms-model-list-view' : ''"
    ...
    <template v-if="useModernListSkin" #queryHeader>
      <div class="modern-list-query-heading">
        ...
        <p class="modern-list-query-desc">维护 CMS 模板、模板类型、默认状态和启用状态。</p>
      </div>
    </template>
...
let singleTable = ref({
  ...
  columns: [
    ...
    {title: '模板名称', dataIndex: 'name', minWidth: 150, align: 'left'},
    {title: '模板类型', dataIndex: 'types', minWidth: 100, align: 'center', dict: 'prt_model_types'},
    {title: '默认', dataIndex: 'if_default', minWidth: 80, align: 'center', dict: 'yes_no'},
    {title: '状态', dataIndex: 'useable', minWidth: 80, align: 'center', dict: 'sys_useable'},
    {title: '排序', dataIndex: 'sort', minWidth: 80, align: 'center'},
  ]
})
