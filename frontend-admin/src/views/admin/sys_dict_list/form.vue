<template>
  <u-form v-model:value="formModel" v-model:disabled="disabled" :labelWidth="180" formNo="sys_dictionary" mainTableTitle="字典分组" :subTables="subTables" subTableType="bottom" extendClass="sys-dict-form-modern">
    <a-row :gutter="16">
      <a-col :span="12">
        <a-form-item name="parent" label="上级" :validateFirst="true" :rules="[{ required: true, message: '请选择上级' }]">
      ...
      <a-col :span="12">
        <a-form-item name="parent_code" label="上级编码" :rules="[{ required: true, message: '请输入上级编码' }]">
...
import sys_dict_item_list_list from "@/views/admin/sys_dict_item_list/list";
...
let subTables = ref([
  {title: '字典项', component: sys_dict_item_list_list},
])
