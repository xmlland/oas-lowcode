...
/*@Configuration
@MapperScan(basePackages = "com.jeestudio.bpm.mapper.base.*", sqlSessionFactoryRef = "sqlSessionFactoryBase")*/
/**
 * @Description: 基础数据源配置（已废弃）
 */
@Deprecated
public class DataSourceBase {

    private static final String MAPPER_XML = "classpath:mapper/mappers/base/*/*.xml";
    private static final String ENTITY = "com.jeestudio.bpm.common.entity.*,com.jeestudio.bpm.common.view.*";
