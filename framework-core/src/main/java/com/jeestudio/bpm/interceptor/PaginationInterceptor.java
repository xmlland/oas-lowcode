...
import com.jeestudio.bpm.interceptor.dialectImpl.*;
...
/**
 * @Description: MyBatis分页拦截器（仅拦截查询语句）
 */
...
public class PaginationInterceptor extends BaseInterceptor {
    ...
    protected Dialect getDialect() {
        ...
        }else if("postgre".equals(dbType) || "postgresql".equals(dbType)){
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (page != null && page.getPageSize() != -1) {
            ...
            page.setCount(SQLHelper.getCount(originalSql, null,
                    mappedStatement, parameterObject, boundSql, log, page.getFromIndex()));
