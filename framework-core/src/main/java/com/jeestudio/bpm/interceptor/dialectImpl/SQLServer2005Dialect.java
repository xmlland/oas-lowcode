package com.jeestudio.bpm.interceptor.dialectImpl;

import com.jeestudio.bpm.interceptor.Dialect;
import com.jeestudio.bpm.utils.StringUtil;

/**
 * @Description: Implementation of PostgreSQL's pagination database dialect
 */
public class SQLServer2005Dialect implements Dialect {
    ...
    private String getLimitString(String querySqlString, int offset, int limit, String limitPlaceholder) {
        ...
        result.append("WITH query AS (SELECT ")
                ...
                .append(offset).append(" AND __row_number__ <= ").append(offset + limit)
