...
import com.jeestudio.bpm.authorization.FieldName;
...
public class ActUtil {
    ...
    public static UserEntityImpl toActivitiUser(User user) {
        if (user == null) {
            return null;
        } else {
    ...
    public static GroupEntityImpl toActivitiGroup(Role role) {
        if (role == null) {
            return null;
        } else {
