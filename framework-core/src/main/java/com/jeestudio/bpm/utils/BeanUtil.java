...
public class BeanUtil extends PropertyUtilsBean {
    ...
    public static void copyBeanHasNull2Bean(Object databean, Object tobean,Map<String,Object> updateNullParamMap) {
        PropertyDescriptor origDescriptors[] = PropertyUtils.getPropertyDescriptors(databean);
        for (int i = 0; i < origDescriptors.length; i++) {
            String name = origDescriptors[i].getName();
            if ("class".equals(name)) {
...
//                        getInstance().setSimpleProperty(tobean, name, value);
//                    }
                    if(value==null && updateNullParamMap.containsKey(name)) {
                        getInstance().setSimpleProperty(tobean, name, null);
                    }else if(value!=null) {
                        getInstance().setSimpleProperty(tobean, name, value);
                    }
                } catch (java.lang.IllegalArgumentException ie) {
